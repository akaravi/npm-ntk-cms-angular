...
@Injectable()
export class ChartContentSimilarService extends ApiCmsServerBase<
...
> {
  ...
  ServiceAddBatch(
    model: ChartContentSimilarModel[]
  ): Observable<ErrorExceptionResult<ChartContentSimilarModel>> {
    if (model == null) {
      model = [];
    }
    return this.http
