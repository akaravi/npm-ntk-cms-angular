...
@Injectable()
export class BiographyContentTagService extends ApiCmsServerBase<
...
> {
  ...
  ServiceAddBatch(
    model: BiographyContentTagModel[]
  ): Observable<ErrorExceptionResult<BiographyContentTagModel>> {
    if (model == null) {
      model = [];
    }
    return this.http
