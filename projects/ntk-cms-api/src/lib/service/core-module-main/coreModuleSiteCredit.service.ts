...
@Injectable()
export class CoreModuleSiteCreditService extends ApiCmsServerBase<
...
> {
  ...
  ServiceGetAllCredit(): Observable<
    ErrorExceptionResult<CoreModuleSiteCreditModel>
  > {
    return this.http
      .get(
  ...
  ServiceChargeDirect(
    model: CoreModuleSiteCreditChargeDirectDtoModel
  ): Observable<ErrorExceptionResult<CoreModuleSiteCreditModel>> {
    if (!model) {
  ...
  ServiceOrderCalculate(
    model: CoreModuleSiteCreditCalculateDtoModel
  ): Observable<
  ...
  ServiceOrderPayment(
    model: CoreModuleSiteCreditPaymentDtoModel
  ): Observable<
