...
@Injectable()
export class TicketingDepartemenOperatorService extends ApiCmsServerBase<
...
> {
  ...
  ServiceGetAllOperator(
    ...
    return this.http
      .post(
        this.getBaseUrl() + this.getModuleControllerUrl() + '/GetAllOperator',
        model,
        {
