...
export class ContactModuleConfigAdminMainValuesModel extends BaseModuleConfigAdminMainValuesModel
{

}

export class ContactModuleConfigSiteAccessValuesModel extends BaseModuleConfigSiteAccessValuesModel
{
...
/// </summary>
export class ContactModuleConfigSiteValuesModel extends BaseModuleConfigSiteValuesModel
{


}

export class ContactModuleSiteStorageValuesModel extends BaseModuleSiteStorageValuesModel
{
