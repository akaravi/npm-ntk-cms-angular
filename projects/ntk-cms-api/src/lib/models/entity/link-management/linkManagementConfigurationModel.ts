...
export class LinkManagementModuleConfigAdminMainValuesModel extends BaseModuleConfigAdminMainValuesModel {

}

export class LinkManagementModuleConfigSiteAccessValuesModel extends BaseModuleConfigSiteAccessValuesModel {
...
/// </summary>
export class LinkManagementModuleConfigSiteValuesModel extends BaseModuleConfigSiteValuesModel {


}

export class LinkManagementModuleSiteStorageValuesModel extends BaseModuleSiteStorageValuesModel {
