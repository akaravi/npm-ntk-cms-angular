...
export class UniversalMenuModuleConfigAdminMainValuesModel extends BaseModuleConfigAdminMainValuesModel
{

}

export class UniversalMenuModuleConfigSiteAccessValuesModel extends BaseModuleConfigSiteAccessValuesModel
{
...
/// </summary>
export class UniversalMenuModuleConfigSiteValuesModel extends BaseModuleConfigSiteValuesModel
{
