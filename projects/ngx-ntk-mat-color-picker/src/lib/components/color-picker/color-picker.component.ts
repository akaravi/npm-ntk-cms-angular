...
export const NGX_MAT_COLOR_PICKER_SCROLL_STRATEGY =
  new InjectionToken<() => ScrollStrategy>('ngx-ntk-mat-colorpicker-scroll-strategy');
...
@Component({
  selector: 'ngx-ntk-mat-color-picker',
  template: '',
 ...
 */
  ...
  private _createPopupPositionStrategy(): PositionStrategy {
    return this._overlay.position()
      ...
      .withTransformOriginOn('.ngx-ntk-mat-colorpicker-content')
