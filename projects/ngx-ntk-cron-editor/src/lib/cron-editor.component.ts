...
export class CronEditorComponent implements OnInit, OnChanges, ControlValueAccessor {
  ...
  // })
  @Input()
  public options: CronOptionModel = defaultCronOptions;
      ...
      case "daily":
        switch (this.state.daily.subTab) {
          case "everyDays":
            ...
            this.cron = `${this.state.daily.everyDays.minutes
              } ${this.hourToCron(
          ...
          case "everyWeekDay":
            // tslint:disable-next-line:max-line-length
            this.cron = `${this.state.daily.everyWeekDay.minutes
              } ${this.hourToCron(
      ...
      case "monthly":
        switch (this.state.monthly.subTab) {
          case "specificDay":
            ...
            // tslint:disable-next-line:max-line-length
            this.cron = `${this.state.monthly.specificDay.minutes
              } ${this.hourToCron(
      ...
      case "yearly":
        switch (this.state.yearly.subTab) {
          case "specificMonthDay":
            ...
            // tslint:disable-next-line:max-line-length
            this.cron = `${this.state.yearly.specificMonthDay.minutes
              } ${this.hourToCron(
          ...
          case "specificMonthWeek":
            // tslint:disable-next-line:max-line-length
            this.cron = `${this.state.yearly.specificMonthWeek.minutes
              } ${this.hourToCron(
                this.state.yearly.specificMonthWeek.hours,
                this.state.yearly.specificMonthWeek.hourType
              )} ? ${this.state.yearly.specificMonthWeek.month} ${this.state.yearly.specificMonthWeek.day
